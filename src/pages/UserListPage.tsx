                      ...
                      <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="py-3 px-4">
                          <div className="flex justify-end gap-2">
                            <Link
                              to={paths.viewUser(user.id)}
                              className="text-xs bg-gray-50 hover:bg-gray-100 text-gray-600 font-medium py-1 px-3 rounded border border-gray-200 transition-colors"
                            >
                              View
                            </Link>
                            <Link
                              to={paths.editUser(user.id)}
                              className="text-xs bg-blue-50 hover:bg-blue-100 text-blue-600 font-medium py-1 px-3 rounded border border-blue-200 transition-colors"
                            >
                              Edit
                            </Link>
                            <button
